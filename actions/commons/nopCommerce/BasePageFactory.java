...
public class BasePageFactory {
	...
	public void sendKeysToElement(WebDriver driver, WebElement webElement, String textValue) {
	...
	public String getElementText(WebDriver driver, WebElement webElement) {
	...
	public void waitForElementPresence(WebDriver driver, String xpathLocator) {
		WebDriverWait explicitWait = new WebDriverWait(driver, 30);
		explicitWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpathLocator)));
	}
