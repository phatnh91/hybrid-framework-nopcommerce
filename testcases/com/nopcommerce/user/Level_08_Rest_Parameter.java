...
public class Level_08_Rest_Parameter extends BaseTest {
...
//		driver = getBrowserDriver(browserName);
	...
	public void User_04_Switch_Page() {
		...
		addressPage = (UserAddressPageObject) customerInfoPage.openPagesAtMyAccount(driver, "Addresses");
		...
		rewardPointPage = (UserRewardPointPageObject) addressPage.openPagesAtMyAccount(driver, "Reward points");
		...
		passwordPage = (UserPasswordPageObject) rewardPointPage.openPagesAtMyAccount(driver, "Change password");
		...
		customerInfoPage = (UserCustomerInfoPageObject) passwordPage.openPagesAtMyAccount(driver, "Customer info");
